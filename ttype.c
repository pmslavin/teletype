...
void initialise_sdl(void)
{
    ...
    SDL_Color bg = {0x2c, 0x1d, 0x7c, 0xff};    // Purple
    SDL_Color fg = {0xf0, 0xb2, 0x0a, 0xff};    // Yellow
//  SDL_Color bg = {0x00, 0x00, 0x00, 0xff};    // Black
//  SDL_Color fg = {0x28, 0xcc, 0x22, 0xff};    // Green
//  SDL_Color bg = {0xff, 0xff, 0xff, 0xff};    // White
//  SDL_Color fg = {0x00, 0x00, 0x00, 0xff};    // Black
